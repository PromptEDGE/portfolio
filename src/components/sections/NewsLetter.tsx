...
const NewsLetterDataBlock = () => {
    ...
    return (
        <>
            <hr className="w-full max-w-[1380px] h-px bg-[#F3D1BF] border-0 mx-auto mb-12" />
            <section className="flex flex-col md:flex-row justify-center items-center md:items-start bg-white px-[38px] md:mx-[135px] py-16 md:py-20 gap-6 md:gap-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row justify-end items-center w-full gap-4 md:gap-8">
                ...
                <button type="submit" name="subscribe" className="outline-none w-full md:w-[170px] h-12 font-['Epilogue'] font-black text-[14px] leading-[100%] tracking-[0px] text-center text-[#391400] shadow-md uppercase hover:-translate-x-2 hover:-translate-y-1 hover:bg-gray-100">subscribe</button>
            </form>
        </section>
        </>
    );
