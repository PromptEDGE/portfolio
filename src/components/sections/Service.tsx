    ...
    return (
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-start items-center md:gap-4 mx-[38px] md:mx-[135px] my-[100px] md:w-full mt-[100px]">
            ...
            <div className="flex flex-col items-center md:items-start justify-start gap-4 md:gap-8 md:mt-[-50px] w-auto mx-[38px] md:mx-0">
                ...
                <h3 className="md:w-[563px] md:h-32 font-['Epilogue'] font-extrabold text-[30px] md:text-[56px] leading-16 tracking-[-1px] text-[#391400] text-center md:text-left">Making Complex Digital Products</h3>

                <h4 className="w-[470px] h-[63px] font-['Epilogue'] font-normal text-[20px] leading-8 tracking-[0px] text-[#391400] text-center md:text-left">Agency provides a full service range including technical skills, design, business.</h4>
...
const MoreService = () => {
    return (
        ...
        <div className="flex flex-col justify-center items-center md:items-start gap-4 mx-[38px] my-[60px] md:mx-[135px] md:my-[65px]">

            {/* heading column container */}
            <div className="flex flex-col justify-start items-center md:items-start gap-4">
                <h2 className="w-[78px] h-8 font-['Epilogue'] font-normal text-[16px] leading-8 tracking-[0px] uppercase text-[#EF6D58]">Service</h2>

                <h3 className="md:w-[400px] h-[96] font-['Epilogue'] font-extrabold text-[28px] md:text-[40px] leading-12 tracking-[-1px] text-[#391400]">How Our Agency Can Help</h3>
            </div> 
