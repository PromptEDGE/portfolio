...
const EventsDataBlock = () => {
    return (
        // event section column container
        <div className="flex flex-col justify-center items-center gap-6 w-full">
            ...
            {/* event cards row container (column on mobile) */}
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 w-full">

                {/* first event card column container */}
                <div className="flex flex-col justify-center items-start gap-4 border border-[#3A3C56] w-full md:w-[370px] h-auto rounded-md px-6 py-8">
                    ...
                    {/* title + description column container */}
                ...
                {/* second event card column container */}
                <div className="flex flex-col justify-center items-start gap-4 border border-[#3A3C56] w-full md:w-[370px] h-auto rounded-md px-6 py-8">
                ...
                {/* third event card column container */}
                <div className="flex flex-col justify-center items-start gap-4 border border-[#3A3C56] w-full md:w-[370px] h-auto rounded-md px-6 py-8">
            ...
            <div className="flex justify-center mt-10">
                ...
                {/* explore more button */}
                <button className="px-6 py-3 text-white font-['Epilogue'] font-black text-[14px] uppercase rounded-md border border-gray-600 hover:bg-[#FF6A00]">
                    Explore More
                </button>
            </div>
        </div>
