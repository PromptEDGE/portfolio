                    ...
                    {menuOpen && (
                        <>
                            ...
                            <motion.div
                                ...
                                className="fixed top-0 right-0 w-64 h-full bg-[#05226E] bg-opacity-95 backdrop-blur-lg p-6 flex flex-col z-50"
                            >
                                ...
                                <nav className="flex flex-col items-center gap-6 mt-8">
                                    <a href="#about" className="text-white text-lg hover:text-gray-300" onClick={() => setMenuOpen(false)}>About</a>
                                    <a href="#work" className="text-white text-lg hover:text-gray-300" onClick={() => setMenuOpen(false)}>Work</a>
                                    <a href="#service" className="text-white text-lg hover:text-gray-300" onClick={() => setMenuOpen(false)}>Service</a>
